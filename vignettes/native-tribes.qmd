...
This vignette demonstrates how to use the `regextable` package to extract references to Native American tribes from text. It highlights the core `extract()` workflow using a specialized lookup table of tribe names and name variants.
