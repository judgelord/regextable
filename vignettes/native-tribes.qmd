...
https://drive.google.com/file/d/1vL_dI4SuvnxwIXr40X12uBoGSSDn_xL-/view?usp=drive_link. 

For this example, a smaller sample of the full dataset is used:

```{r}
tribes_df <- read.csv("https://drive.google.com/uc?export=download&id=1y4PwIYBdXoW6RmlGUeA9Qk3Josp0P0dl")
```
