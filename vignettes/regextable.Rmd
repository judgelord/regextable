...
`regextable` provides a efficient framework for extracting structured information from text using pattern-based regular expressions. The package is optimized to handle large datasets with thousands of patterns using a "shrinking pool" algorithm, which stops searching rows once a match is found, improving speed.
