...
The function also supports additional parameters such as `do_clean_text`, `unique_match`, `verbose`, and `cl`. These can be used to control text cleaning, limit matches per row, show progress messages, or speed up processing on large datasets.
