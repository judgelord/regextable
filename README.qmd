...
If the `spacyr` package is installed and initialized, `extract()` can use Named Entity Recognition (NER) to validate that regex matches are actual entities (such as Organizations or People) in the text.
