...
-   **`col_name`**: (default `"text"`) Column name in the data frame containing text to search through. *(Note: If `data` is a character vector, it is internally converted to a data frame and this argument is ignored).*
...
Shows how to use optional arguments for more control, such as filtering by date ranges and removing acronyms. 
This is useful when you want to narrow matches, disable text cleaning, control returned columns, or suppress messages.
