...
## Text cleaning
Before searching text, `clean_text()` standardizes formatting to improve matching.
It removes excess punctuation and spacing, lowercases text, and normalizes formatting.
```{r}
