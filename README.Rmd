...
For example, you can provide a table of names, companies, or acronyms as the regex table, and any data frame of text as input. The included example datasets (`members` and `cr2007_03_01`) demonstrate usage, but these are not defaults, you can use any data you like.
